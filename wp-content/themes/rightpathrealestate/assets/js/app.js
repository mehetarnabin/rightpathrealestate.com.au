...
$(function(){
    ...
    $options.on("click", function(){
        ...
        $agents.each(function(){
            ...
            if(value === "all" || agentCity === value){
                ...
                $agent.stop(true, true).fadeOut(300);
            }
        });
    });
    ...
    $(document).on("click", function(e){
        if(!$(e.target).closest(".fancy-dropdown").length){
            $dropdown.removeClass("active");
        }
    });
...
$(document).ready(function() {
    $('#faq .faq-toggle').click(function(e) {
        e.preventDefault();
        ...
        $('#faq .card-block.open').not($target).removeClass('open');
        $('#faq .faq-toggle').not($this).removeClass('open');
