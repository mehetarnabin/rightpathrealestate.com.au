    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active item-bg">
                <img class="d-block w-100 h-100" src="<?php bloginfo('template_directory') ?>/assets/img/banner/img-5.png" alt="banner">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 wow fadeInLeft delay-04s">
                <div class="services-info-2">
                    <div class="inner">
                        <div class="inner-top">
                            <h4><a href="#">Personalized Service</a></h4>
                            <i class="flaticon-user"></i>
                        </div>
                        <div class="inner-buttom si1">
                            <p>We’re passionate about providing personalised service, offering expert advice, and making sure you feel supported every step of the way. Your goals are our priority, and we’re here to guide you with care, attention, and local knowledge.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 wow fadeInUp delay-04s">
                <div class="services-info-2">
                    <div class="inner">
                        <div class="inner-top">
                            <h4><a href="#">Real Estate Experts</a></h4>
                            <i class="flaticon-hotel-building"></i>
                        </div>
                        <div class="inner-buttom si2">
                            <p>We understand that every property journey is unique — and so is what you're looking for. Whether you're a first-time buyer, seasoned investor, tenant, or seller, we’re here to help you find exactly what fits your needs, lifestyle, and goals.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12 wow fadeInRight delay-04s">
                <div class="services-info-2">
                    <div class="inner">
                        <div class="inner-top">
                            <h4><a href="#">Build Your Dream</a></h4>
                            <i class="flaticon-money-bag-with-dollar-symbol"></i>
                        </div>
                        <div class="inner-buttom si3">
                            <p>We help homebuyers across Australia find more than just a property — we help you find your right place. From suburban family homes to modern city apartments, we guide you through the process with local insights and personalised support.</p>
                        </div>
                    </div>
                </div>
            </div>
